...
with agents_client:
    ...
    agent = agents_client.create_agent(
        ...
        name="mcp-agent",
        instructions="""You have access to an MCP server called `microsoft.docs.mcp` - this tool allows you to 
    ...
    message = agents_client.messages.create(
        thread_id=thread.id, content=prompt, role=MessageRole.USER
    )
