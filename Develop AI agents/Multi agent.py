...
with agents_client:
    ...
    priority_agent = agents_client.create_agent(
        ...
        instructions=priority_agent_instruction,
    )

    # Create an agent to assign the tickets to appropriate team
    ...
    team_agent = agents_client.create_agent(
        ...
        instructions=team_agent_instruction,
    )
    ...
    # Create connected agents tools for the support agents
    ...
    team_agent_tool = ConnectedAgentTool(
        id=team_agent.id,
        name=team_agent_name,
        description="Determine which team should take the ticket",
    )
    ...
    # Use the agent agents to triage a support ticket
    print("Creating agent thread.")
    thread = agents_client.threads.create()

    # Create the ticket prompt
    prompt = input("\nWhats the support problem you need to resolve?: ")
    ...
    print("\nProcessing the agent thread. Please wait.\n")
